					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										...
										<tbody>
											<tr>
												...
												<td style="text-align:left" nowrap><span class="btn btn-label-brand btn-sm">Selesai</span></td>
										  ...
										  <tr>
												...
												<td style="text-align:left" nowrap><span class="btn btn-label-linkedin btn-sm">Member</span></td>
