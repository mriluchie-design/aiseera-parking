...
<div class="col-lg-10">
					  ...
					  <div class="col-lg-3">
                          <label>Scan QR Code Member :</label>
                          <div class="kt-input-icon kt-input-icon--right">
      <input type="text" class="form-control form-control-sm" placeholder="Scan QR Code Disini..." disabled id="generalSearch" />
...
<div class="col-lg-2">
                      ...
                      <div class="form-group row" style="text-align:center">
														...
														<div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_user_edit_avatar">
																			<div class="kt-avatar__holder" style="width:180px; height:200px; background-image: url(../assets/media/kendaraan/masuk-mobil-1a.png);"></div>
                      ...
                      <div class="form-group row">
						<div class="col-lg-12" >
                          ...
                          <div class="kt-input-icon kt-input-icon--right">
      <input type="text" class="form-control form-control-sm" placeholder="Scan Kartu e-Money..." disabled id="generalSearch" />
      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span></span></div>
                        </div>
						...
						<div class="col-lg-6" >
                          ...
                          <input type="text" class="form-control form-control-sm" placeholder="Mobil" disabled>
                        </div>
						<div class="col-lg-6">
                      ...
                      <div class="col-lg-6">
						...
						<div class="col-lg-6" >
                          <label style="color:#a2050c">Pembayaran :</label>
                           <input type="text" class="form-control form-control-sm" placeholder="QRIS" disabled>
                        </div>
                      <div class="col-lg-6">
