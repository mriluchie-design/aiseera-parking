    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            ...
            <div class="kt-subheader__toolbar">
				...
				<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_cetak_karcis_masuk"><i class="fa fa-receipt"></i>Cetak Karcis Baru</button>
...
<tr>
  ...
  <td nowrap="nowrap" style="text-align:center"><a href="#" class="" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true"><img style="width:130px; height:80px;" src="../assets/media/kendaraan/keluar-mobil-2.png" alt="image" /></a></td>
	  ...
	  <td nowrap="nowrap" style="text-align:center"><div class="kt-widget2__actions"> <a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown"> <i class="flaticon-more-1"></i> </a>
			...
			<!--begin::Modal 1-->
									<div class="modal fade" id="modal_cetak_karcis_masuk" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
								<div class="modal-dialog modal-dialog-centered modal-md" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<span class="kt-portlet__head-icon"><i class="kt-font-brand fa fa-receipt"></i></span>
												<h3 class="kt-portlet__head-title kt-font-danger kt-bold">CETAK KARCIS MASUK</h3>
											</div>
										...
										<div class="kt-portlet__body">
											<div class="tab-content">
												...
												<div class="form-group row">
												<div class="col-lg-6">
                          <label class=""><code data-toggle="kt-tooltip" data-skin="light" title="" data-original-title="" data-html="true">*</code> Jumlah Karcis :</label>
