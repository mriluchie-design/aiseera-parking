            ...
            <!--end::Form-->
													...
													<div class="kt-widget17__items">
														<div class="kt-widget17__item">
															...
															<span class="kt-widget17__desc kt-font-success" style="text-align:center">
																<span style="font-size:16px; font-weight:500;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 6.161.188.514,-</span>
															</span>
														</div>
														<div class="kt-widget17__item">
															<span class="kt-widget17__icon" style="text-align:center">
															...
															<span class="kt-widget17__desc kt-font-success" style="text-align:center">
																<span style="font-size:16px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 3.493.710.473,-</span>
															</span>
														</div>
														...
														<div class="kt-widget17__item">
															...
															<span class="kt-widget17__desc kt-font-success" style="text-align:center">
																<span style="font-size:16px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 0,-</span>
															</span>
														</div>
														<div class="kt-widget17__item">
															<span class="kt-widget17__icon" style="text-align:center">
														...
														<div class="kt-widget17__item">
															...
															<span class="kt-widget17__desc kt-font-success" style="text-align:center">
																<span style="font-size:16px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 2.315.640.000,-</span>
															</span>
														</div>
														<div class="kt-widget17__item">
															<span class="kt-widget17__icon" style="text-align:center">
															...
															<span class="kt-widget17__desc kt-font-success" style="text-align:center">
																<span style="font-size:16px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 251.838.000,-</span>
															</span>
														</div>
														<div class="kt-widget17__item">
															<span class="kt-widget17__icon" style="text-align:center">
															...
															<span class="kt-widget17__desc kt-font-success" style="text-align:center">
																<span style="font-size:16px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 100.000.000,-</span>
															</span>
														</div>
				...
				<form class="kt-margin-l-20" id="kt_subheader_search_form">
										...
										<div class="kt-portlet__body"><br>
											...
											<figure class="highcharts-figure">
													<div id="container-cabang-rekap-pendapatan-realisasi" style="height:400px"></div>
											</figure>
										</div>
									</div>
						</div>
				...
				<form class="kt-margin-l-20" id="kt_subheader_search_form">
					...
					<div>&nbsp;</div>
						...
						<script src="../assets/js/chart/cabang-rekap-pendapatan-realisasi.js" type="text/javascript"></script>
