...
<div class="m-portlet m-portlet--tabs">
					  ...
					  <div class="col-lg-3">
						...
						<div class="col-lg-6">
                         ...
                         <div class="input-group">
													<input type="text" class="form-control form-control-sm kt-input-sm" placeholder="23:30:00" aria-describedby="basic-addon2" disabled>
													<div class="input-group-append">
														<span class="input-group-text" id="basic-addon2">WITA</span>
													</div>
												</div>
					 ...
					 <div class="col-lg-12">
										...
										<thead>
											...
											<tr style="text-align:center">
											  ...
											  <th width="8%" bgcolor="#feffed">QR Code</th>
											  <th width="2%" bgcolor="#feffed">By</th>
										  </tr>
										</thead>
										<tbody>
											<tr>
...
<tr>
  ...
  <td nowrap="nowrap" style="text-align:center">Keluar</td>
  <td nowrap="nowrap" style="text-align:center">Mobil - 1</td>
  <td class="text-center"><span class="btn btn-label-danger btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Stok Kosong" data-html="true">0</span></td>
												<td nowrap="nowrap" style="text-align:center">Unit</td>
												<td nowrap="nowrap" style="text-align:center"><div class="kt-input-icon kt-input-icon--right">
      <input type="text" class="form-control form-control-sm" placeholder="Scan Perangkat" id="generalSearch" disabled>
      <span class="kt-input-icon__icon kt-input-icon__icon--right"> <span><i class="fa fa-barcode"></i></span> </span> </div></td>
  <td nowrap="nowrap" style="text-align:center">-</td>
  <td nowrap="nowrap" style="text-align:center"><label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand">
															    <input type="checkbox" checked="checked">
