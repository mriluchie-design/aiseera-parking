					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="10%" rowspan="2" bgcolor="#f7fcff">Lokasi</th>
											  <th colspan="4" bgcolor="#f7fcff">Pembayaran</th>
											  <th colspan="6" bgcolor="#f7fcff">Pemesanan Pembelian / PO</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Validasi</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Status</th>
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">Aksi</th>
										  </tr>
											<tr style="text-align:center">
											  <th width="1%" bgcolor="#f7fcff">Nomor Bukti</th>
											  <th width="1%" bgcolor="#f7fcff">Waktu</th>
											  <th width="3%" bgcolor="#f7fcff">By </th>
											  <th width="3%" bgcolor="#f7fcff">Metode</th>
											  <th width="1%" bgcolor="#f7fcff">Nomor / Waktu</th>
											  <th width="1%" bgcolor="#f7fcff">Vendor</th>
											  <th width="7%" bgcolor="#f7fcff">Total</th>
											  <th width="7%" bgcolor="#f7fcff">Uang Muka</th>
											  <th width="7%" bgcolor="#f7fcff">Sisa Pembayaran</th>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:left" nowrap><span style="text-align:center">110103.0626.01.005</span></td>
												...
												<td nowrap="nowrap" style="text-align:center">Transfer Bank<hr />BCA
												  <hr />
											    0255804010</td>
												<td nowrap="nowrap" style="text-align:center">PO.062026.01.0005
												  <hr />24 September 2026<hr>06:50:00 WITA</td>
												...
												<td nowrap="nowrap" style="text-align:center"><div class="kt-widget2__actions"> <a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown"> <i class="flaticon-more-1"></i> </a>
												  <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
												    <ul class="kt-nav">
												      ...
												      <li class="kt-nav__item"> <a href="pembayaran-edit.php" class="kt-nav__link"> <i class="kt-nav__link-icon fa fa-edit"></i> <span class="kt-nav__link-text">Edit</span> </a> </li>
												      <li class="kt-nav__item"> <a href="pembayaran-cetak.php" class="kt-nav__link"> <i class="kt-nav__link-icon fa fa-receipt"></i> <span class="kt-nav__link-text">Cetak</span> </a> </li>
										  ...
										  <tr>
												...
												<td nowrap="nowrap" style="text-align:left"><span style="text-align:center">110103.0626.01.004</span></td>
												<td nowrap="nowrap" style="text-align:center">24 September 2026
												  <hr />
												  06:50:00 WITA</td>
												<td nowrap="nowrap" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="12321355123123214&lt;hr&gt;Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
												<td nowrap="nowrap" style="text-align:center">Tunai
												  <hr />
												  -
												  <hr /> 
												  -
</td>
												<td nowrap="nowrap" style="text-align:center">PO.062026.01.0004
												  <hr />
												  24 September 2026
												  <hr />
											    06:50:00 WITA</td>
...
<tr>
												...
												<td nowrap="nowrap" style="text-align:left">Makassar</td>
												<td nowrap="nowrap" style="text-align:left"><span style="text-align:center">110103.0626.01.003</span></td>
												<td nowrap="nowrap" style="text-align:center">24 September 2026
												  <hr />
												  06:50:00 WITA</td>
												<td nowrap="nowrap" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="12321355123123214&lt;hr&gt;Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
												<td nowrap="nowrap" style="text-align:center">Virtual Account
												  <hr />
												  BCA
                                                  <hr />
0255804010</td>
												<td nowrap="nowrap" style="text-align:center">PO.062026.01.0003
												  <hr />
												  24 September 2026
												  <hr />
											    06:50:00 WITA</td>
...
<tr>
												...
												<td style="text-align:left" nowrap>Makassar</td>
												<td style="text-align:left" nowrap><span style="text-align:center">110103.0626.01.002</span></td>
												<td nowrap="nowrap" style="text-align:center">24 September 2026
												  <hr />
												  06:50:00 WITA</td>
												<td nowrap="nowrap" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="12321355123123214&lt;hr&gt;Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
												<td nowrap="nowrap" style="text-align:center">QRIS
												  <hr />
												  Mandiri
                                                  <hr />
0255804010</td>
												<td nowrap="nowrap" style="text-align:center">PO.062026.01.0002
												  <hr />
												  24 September 2026
												  <hr />
											    06:50:00 WITA</td>
...
<tr>
  ...
  <td nowrap="nowrap" style="text-align:left"><span style="text-align:center">110103.0626.01.001</span></td>
  <td nowrap="nowrap" style="text-align:center">24 September 2026
    <hr />
    06:50:00 WITA</td>
  <td nowrap="nowrap" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="12321355123123214&lt;hr&gt;Muhammad Nasrullah, S.Kom" data-html="true"><img src="../assets/media/users/100_3.jpg" alt="image" /></a></td>
  <td nowrap="nowrap" style="text-align:center">Transfer Bank
    <hr />
    BCA
    <hr />
0255804010</td>
  <td nowrap="nowrap" style="text-align:center">PO.062026.01.0001
    <hr />
    24 September 2026
    <hr />
    06:50:00 WITA</td>
