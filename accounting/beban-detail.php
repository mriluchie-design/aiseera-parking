						...
						<div class="kt-portlet__content">
							...
							<table class="table table-bordered table-hover table-checkable">
																				<thead>
																					<tr>
																					  <th width="1%" bgcolor="#f7fcff">#</th>
																						<th width="17%" bgcolor="#f7fcff">Akun</th>
																						<th width="5%" bgcolor="#f7fcff">Lampiran Dokumen</th>
																						<th width="25%" bgcolor="#f7fcff">Catatan</th>
																				...
																				<tbody>
																					<tr>
																					  <td>1</td>
																						<td><input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="600003 - Beban Bensin, Parkir, Tol Kendaraan"></td>
																						...
																						<td style="text-align:center"><input type="text" class="form-control form-control-sm" placeholder="" disabled></td>
																					...
																					<tr>
																					  <td>2</td>
																						<td><input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="600007 - Beban Katering & Makan Karyawan"></td>
																						<td style="text-align:center"><button type="button" class="btn btn-outline-brand btn-sm"><i class="fa fa-file-download"></i>Download</button></td>
																						<td style="text-align:center"><input type="text" class="form-control form-control-sm" placeholder=""  disabled></td>
																						<td nowrap="nowrap" style="text-align:left"><div class="input-group input-group-sm">
																						  <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
																					...
																					<tr>
																					  <td>3</td>
																						<td><input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="600013 - Beban Telekomunikasi"></td>
																						<td style="text-align:center"><button type="button" class="btn btn-outline-brand btn-sm"><i class="fa fa-file-download"></i>Download</button></td>
																						<td style="text-align:center"><input type="text" class="form-control form-control-sm" placeholder=""  disabled></td>
																						<td nowrap="nowrap" style="text-align:left"><div class="input-group input-group-sm">
																						  <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
																...
																<tfoot style="border-top: 2px solid #5867dd">
																	<tr>
																		<th colspan="4" bgcolor="#f7fcff" class="text-right"><strong>Total</strong></th>
