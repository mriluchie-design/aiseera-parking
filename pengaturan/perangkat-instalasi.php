					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="3%" rowspan="2" bgcolor="#f7fcff">Nama Jalur</th>
											  <th colspan="4" bgcolor="#f7fcff">Instalasi</th>
											  <th width="5%" rowspan="2" bgcolor="#f7fcff">Status Instalasi</th>
											...
											<tr style="text-align:center">
											  ...
											  <th width="2%" bgcolor="#f7fcff">Tanggal Mulai</th>
											  <th width="2%" bgcolor="#f7fcff">Tanggal Selesai</th>
								          </tr>
										</thead>
										<tbody>
											<tr>
												...
												<td nowrap="nowrap" style="text-align:center"><div class="progress">
												  <div class="progress-bar progress-bar-striped progress-bar-animated bg-danger" role="progressbar" style="width: 10%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">0%</div>
												  </div></td>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																		...
																		<li class="kt-nav__item">
																			<a href="perangkat-instalasi-add.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-list-ol"></i>
																				<span class="kt-nav__link-text">Instalasi</span>
																			</a>
																		</li>
												...
												<td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																		...
																		<li class="kt-nav__item">
																			<a href="perangkat-detail-instalasi.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Detail</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
																			<a href="perangkat-edit-instalasi.php" class="kt-nav__link">
