...
function goBack() {
  ...
  <tbody><tr style="text-align:center">
    ...
    <tr style="text-align:center">
      <td width="2%" bgcolor="#f7fcff" >Volume</td>
      <td width="2%" bgcolor="#f7fcff" >Satuan</td>
    </tr>
  
    <tr>
      <td style="text-align:right" bgcolor="#fdfdec">A</td>
      <td style="text-align:center" bgcolor="#fdfdec"><select name="select" class="form-control kt-selectpicker" data-live-search="true">
        <option value="AK" selected="selected">DISPENSER SINGLE</option>
        <option value="AK">DISPENSER DOUBLE</option>
      </select></td>
      <td colspan="2" bgcolor="#fdfdec" style="text-align:center">&nbsp;</td>
      <td style="text-align:center" bgcolor="#fdfdec" nowrap><button type="button" class="btn btn-brand btn-elevate btn-icon btn-icon btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Tambah Kategori" data-html="true"><i class="fa fa-list"></i></button> <button type="button" class="btn btn-outline-hover-danger btn-sm btn-icon"><i class="fa fa-trash-alt"></i></button></td>
    </tr>
    <tr>
    ...
    <td style="text-align:left"><span style="text-align:center">
      <select name="select8" class="form-control kt-selectpicker" data-live-search="true">
        <option value="AK" selected="selected">NFC PAYMENT READER</option>
...
<tr>
    ...
    <td style="text-align:left"><span style="text-align:center">
      <select name="select8" class="form-control kt-selectpicker" data-live-search="true">
        ...
        <option value="AK" selected="selected">PRINTER THERMAL</option>
		  <option value="AK" >HUB SWITCH 8 PORT MANAGEABLE CLOUD</option>
      </select>
    </span></td>
    <td style="text-align:center"><input id="kt_touchspin_4" type="text" class="form-control form-control-sm bootstrap-touchspin-vertical-btn" value="" name="demo1" placeholder="1"></td>
...
<tr>
    ...
    <td style="text-align:left"><span style="text-align:center">
      <select name="select8" class="form-control kt-selectpicker" data-live-search="true">
        <option value="AK" >NFC PAYMENT READER</option>
        <option value="AK" >PRINTER THERMAL</option>
		  <option value="AK" selected>HUB SWITCH 8 PORT MANAGEABLE CLOUD</option>
      </select>
    </span></td>
    <td style="text-align:center"><input id="kt_touchspin_4" type="text" class="form-control form-control-sm bootstrap-touchspin-vertical-btn" value="" name="demo1" placeholder="1"></td>
    <td><span style="text-align:center">
...
<tr>
  <td style="text-align:right" bgcolor="#fdfdec">B</td>
  <td style="text-align:center" bgcolor="#fdfdec"><select name="select" class="form-control kt-selectpicker" data-live-search="true">
    <option value="AK" selected="selected">BARRIER GATE</option>
    <option value="AK">DISPENSER DOUBLE</option>
  </select></td>
  <td colspan="2" bgcolor="#fdfdec" style="text-align:center">&nbsp;</td>
  <td style="text-align:center" bgcolor="#fdfdec" nowrap><button type="button" class="btn btn-brand btn-elevate btn-icon btn-icon btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Tambah Kategori" data-html="true"><i class="fa fa-list"></i></button> <button type="button" class="btn btn-outline-hover-danger btn-sm btn-icon"><i class="fa fa-trash-alt"></i></button></td>
...
<tr>
  <td style="text-align:right" bgcolor="#fdfdec">C</td>
  <td style="text-align:center" bgcolor="#fdfdec"><select name="select10" class="form-control kt-selectpicker" data-live-search="true">
    <option value="AK" selected="selected">TIANG & SENSOR</option>
    <option value="AK">DISPENSER DOUBLE</option>
  </select></td>
  <td colspan="2" bgcolor="#fdfdec" style="text-align:center">&nbsp;</td>
  <td style="text-align:center" bgcolor="#fdfdec" nowrap><button type="button" class="btn btn-brand btn-elevate btn-icon btn-icon btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Tambah Kategori" data-html="true"><i class="fa fa-list"></i></button> <button type="button" class="btn btn-outline-hover-danger btn-sm btn-icon"><i class="fa fa-trash-alt"></i></button></td>
...
<tr>
    ...
    <td style="text-align:left"><span style="text-align:center">
       <select name="select8" class="form-control kt-selectpicker" data-live-search="true">
        <option value="AK">UHF READER MID RANGE</option>
        <option value="AK" selected>IP CAMERA</option>
      </select>
    </span></td>
    <td style="text-align:center"><input id="kt_touchspin_4" type="text" class="form-control form-control-sm bootstrap-touchspin-vertical-btn" value="" name="demo1" placeholder="1"></td>
    <td><span style="text-align:center">
