				...
				<div class="kt-portlet__body">
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										...
										<tbody>
											<tr>
												<td align="right">1</td>
												<td style="text-align:left" nowrap>Lupa Absen Datang</td>
										  ...
										  <tr>
												<td align="right">2</td>
												<td style="text-align:left" nowrap>Lupa Absen Pulang</td>
												<td nowrap="nowrap" style="text-align:center"><div class="kt-widget2__actions"> <a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown"> <i class="flaticon-more-1"></i> </a>
										      <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
										        <ul class="kt-nav">
										  ...
										  <tr>
										    <td align="right">3</td>
										    <td style="text-align:left" nowrap>Lupa Absen Lembur Masuk</td>
										    <td nowrap="nowrap" style="text-align:center"><div class="kt-widget2__actions"> <a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown"> <i class="flaticon-more-1"></i> </a>
										      <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
										        <ul class="kt-nav">
										  ...
										  <tr>
										    <td align="right">4</td>
										    <td style="text-align:left" nowrap>Lupa Absen Lembur Pulang</td>
										    <td nowrap="nowrap" style="text-align:center"><div class="kt-widget2__actions"> <a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown"> <i class="flaticon-more-1"></i> </a>
										      <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
										        <ul class="kt-nav">
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-danger kt-bold">TAMBAH JENIS LUPA ABSEN</h3>
											</div>
										...
										<div class="kt-portlet__body">
											<div class="tab-content">
												...
												<div class="form-group row">
												<div class="col-lg-12">
														<label class="kt-font-brand">JENIS LUPA ABSEN :</label>
