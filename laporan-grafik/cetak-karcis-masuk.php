...
function goBack() {
			...
			<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
				...
				<!--end::Nav-->
							...
							<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid mt-3">
								<div class="bg-white w-25 ml-auto mr-auto" style="margin-bottom:130px; margin-top:50px;">
  ...
  <tr>
   ...
   <tr>
    <td style="text-align: center; font-size:12px;"><strong>PT. PELABUHAN INDONESIA (PERSERO) REGIONAL 4</strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="text-align: center; font-size:12px; padding-top:10px;"><strong>BUKTI PEMBAYARAN MASUK</strong></td>
  </tr>
