													...
													<div class="kt-widget17__items">
														<div class="kt-widget17__item">
															...
															<span class="kt-widget17__desc kt-font-success" style="text-align:center">
																<span style="font-size:17px; font-weight:500;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 73.000,-</span>
															</span>
														</div>
														<div class="kt-widget17__item">
															<span class="kt-widget17__icon" style="text-align:center">
															...
															<span class="kt-widget17__desc kt-font-success" style="text-align:center">
																<span style="font-size:17px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 23.000,-</span>
															</span>
														</div>
														...
														<div class="kt-widget17__item">
															...
															<span class="kt-widget17__desc kt-font-success" style="text-align:center">
																<span style="font-size:17px;" class="kt-nav__link" data-toggle="modal" data-target="#modal_hadir">Rp. 50.000,-</span>
															</span>
														</div>
