...
Highcharts.chart('container-cabang-monitoring-pendapatan-harian', {
    ...
    series: [{
        name: 'e-Money',
        data: [1500000000, 1000000000, 300000000, 300000000, 200000000, 150000000, 300000000, 186119460, 200000000,],
        
    }, {
        name: 'QRIS',
        data: [73090473, 152720540, 55301419, 111151352, 103125743, 160832635, 104610945, 100000000, 197232568,]
    }]
});
